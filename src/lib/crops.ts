...
export const CROPS: Crop[] = [
  ...
  },
  {
    ...
    tagline: "Temperate winter grain with compact bearded spikes",
    modeled: false,
    accent: "grain",
    summary: "A cool-season grass with erect spikes and awns, grown on dryland soils across temperate belts.",
    taxonomy: [
